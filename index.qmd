---
title: "Workshop: CO2 Emissions Report"
author: "Amanda Mabhula"
format: 
    html:
...
emissions_long_1990_2022 = emissions_long.query("year >= 1990")

# Query for 5 countries (adjust these to any countries you like)
emissions_long_subset = emissions_long_1990_2022.query("country.isin(['Argentina', 'Belgium', 'South Africa', 'China', 'USA'])")
...
fig_chart = px.line(
    ...
    y = "emissions",
    color = "country",
    labels = {"emissions": "CO2 Emissions (tonnes)", "year" : "Year"},
    title = "Country-specific CO2 emission trends (1990-2022)",
    log_y=True,
    category_orders={"country" : ["China", "USA", "South Africa", "Belgium", "Argentina"]}
    )
...
Global and country-specific CO2 emissions from 1990 to 2022, in table, chart and map format:
